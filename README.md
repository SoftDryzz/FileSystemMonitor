...
? **Opci¢n para ignorar archivos del sistema y la papelera de reciclaje**.  
? **Soporte para m£ltiples idiomas (Espa?ol/Ingl‚s)** basado en la configuraci¢n del sistema.  
? **Optimizaci¢n para evitar spam de eventos repetidos**.  
